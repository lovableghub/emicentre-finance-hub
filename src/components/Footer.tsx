...
const Footer = () => {
  return (
    <footer className="bg-background border-t w-full py-6 md:py-10">
      <div className="container grid gap-8 md:grid-cols-2 lg:grid-cols-4">
        <div>
          <h3 className="font-semibold text-lg mb-3">WorkConnect</h3>
        ...
        <div>
          ...
          <ul className="space-y-2 text-sm">
            <li>
              <Link to="/jobs" className="text-muted-foreground hover:text-foreground">Job Board</Link>
            </li>
            <li>
              <Link to="/membership" className="text-muted-foreground hover:text-foreground">Membership Plans</Link>
            </li>
            <li>
